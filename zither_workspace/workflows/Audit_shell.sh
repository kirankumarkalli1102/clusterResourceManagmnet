...
echo $workflow_id|$job_name|$start_time|$end_time|$status|$run_type|$feed_record_count|$attachment_file|$housekeeping_files_deleted|$number_of_compacted_files|$hdfs_path|$error_msg

echo "$workflow_id|$job_name|$start_time|$end_time|$status|$run_type|$feed_record_count|$attachment_file|$housekeeping_files_deleted|$number_of_compacted_files|$hdfs_path|$error_msg" >> $audit_file_path
